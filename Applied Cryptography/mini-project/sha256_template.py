...
Modified from a version by Thomas Dixon
...
class sha256(object):
    ...
    def update(self, m):
        ...
        #Pad the message up to 64 bit block lengths, then apply the function as follows
    ...
    def digest(self):
        return ''.join([struct.pack('!L', i) for i in self._h[:self._output_size]])
